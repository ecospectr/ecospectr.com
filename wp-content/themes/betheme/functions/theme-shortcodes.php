...
if( ! function_exists( 'sc_blog' ) )
{
	function sc_blog( $attr, $content = null )
	{
		...
		$output = '<div class="column_filters">';
			...
			// Echo | Filters
			if( $filters && $style == 'masonry' && ! $category && ! $category_multi ){
						...
						$output .= '<ul class="authors">';
							...
							if( is_array( $authors ) ){
								foreach( $authors as $auth ){
									$output .= '<li class="'. $auth->data->user_login .'"><a data-rel=".author-'. $auth->data->user_login .'" href="'. get_author_posts_url($auth->ID) .'">'. $auth->data->display_name .'</a></li>';
								}
							}
							$output .= '<li class="close"><a href="#"><i class="icon-cancel"></i></a></li>';
						$output .= '</ul>';
